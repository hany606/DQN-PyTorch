...
rewards = dqn_agent.train(return_rewards=True, save_flag=True, render=False, save_file_path="./dqn_trained_agents/", save_file_name="best_model_dqn",
                          num_epochs=num_epochs, batch_size=batch_size, target_update_freq=target_update_freq,  eps_prob=eps_prob, learning_rate=learning_rate, num_steps=num_steps)
...
plt.xlabel("Epochs")
plt.ylabel("Reward")
plt.savefig("./dqn_trained_agents/best_model_dqn.png")
plt.show()
